...
# Utilizo POO para generar el Perceptron
...
# Entreno el modelo del Perceptron 
...
def plot_decision_regions(X, y, classifier, resolution=0.02):
    ...
    # defino un generador de marcadores y un mapa de colores
    markers = ('s', 'x', 'o', '^', 'v')
    colors = ('red', 'blue', 'lightgreen', 'gray', 'cyan')
    cmap = ListedColormap(colors[:len(np.unique(y))])

    # represento la superficie de decisión 
